 ...
 */
final class Version20220619105950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE magazine (id INT AUTO_INCREMENT NOT NULL, titre_id INT NOT NULL, code_affaire VARCHAR(63) NOT NULL, code_affaire_en_clair VARCHAR(255) NOT NULL, date_de_bouclage VARCHAR(255) DEFAULT NULL, date_de_parution VARCHAR(255) DEFAULT NULL, titre_en_clair VARCHAR(127) DEFAULT NULL, nb_de_page_redactionnelle DOUBLE PRECISION DEFAULT NULL, INDEX IDX_378C2FE4D54FAE5E (titre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE redachef (id INT AUTO_INCREMENT NOT NULL, salarie_et_entreprise_id INT NOT NULL, magazine_id INT NOT NULL, article VARCHAR(63) DEFAULT NULL, signe INT DEFAULT NULL, nb_de_feuillet DOUBLE PRECISION DEFAULT NULL, forfait DOUBLE PRECISION DEFAULT NULL, prix_au_feuillet DOUBLE PRECISION DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, montant_total_brut DOUBLE PRECISION DEFAULT NULL, montant_charge DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_B6E2A08DB1383DD6 (salarie_et_entreprise_id), INDEX IDX_B6E2A08D3EB84A1D (magazine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, pseudonym VARCHAR(255) DEFAULT NULL, username VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
